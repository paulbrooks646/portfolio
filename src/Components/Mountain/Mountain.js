   ...
   const toggleMountainFirst = () => {
    ...
    return (
      <div className="mountain-main">
        ...
        <Card
          className={`${props.user.user.mountain ? "answer-card" : "answer-card-closed"}`}
        >
          <Typography
            variant="h6"
            color="secondary"
        ...
        <Card className={`${mountaineer ? "mountain-card" : "mountain-card-closed"}`}>
          <Typography
            variant="h5"
            color="primary"
        ...
        <Card className={`${answerOne ? "answer-card" : "answer-card-closed"}`}>
          ...
          <Typography
            ...
            className="answer-card-description"
          >
            Griffins are massive birds. They are very fast and very protective of their young. Griffins typically won't attack humans unless a human gets too close to the Griffin's nest.
          </Typography>
          <Button
        ...
        <Card className={`${answerTwo ? "answer-card" : "answer-card-closed"}`}>
          ...
          <Typography
            ...
            className="answer-card-description"
          >
            There are nests all throughout the cliffs up in the mountains. They are home to giant birds like Rocs and Griffins. Griffins are particularly common in this area.
          </Typography>
          <Button
        ...
        <Card
          className={`${answerThree ? "answer-card" : "answer-card-closed"}`}
        >
          <Typography
            variant="h4"
            color="primary"
          ...
          <Typography
            ...
            className="answer-card-description"
          >
            Ogres are massive. Funny creatures, you could hit an Ogre as hard as you like, it wouldn't hurt the Ogre and he wouldn't feel it. You could scream as loud as you want, an Ogre wouldn't even notice. But an Ogre's sense of smell is unrivaled. Ogre's keep to themselves but can get aggressive if they smell something nasty enough.
          </Typography>
          <Button
        ...
        <Card
          className={`${answerFour ? "answer-card" : "answer-card-closed"}`}
        >
          <Typography
            variant="h4"
            color="primary"
          ...
          <Typography
            ...
            className="answer-card-description"
          >
            As snow in the mountains melt, it flows down the mountain. Many people and creatures depend on that water. The pass is a point this water is shallow enough to cross, it is the only way through the mountains.
          </Typography>
          <Button
